...
- **auth**: enforce catalog credential boundaries (#2375)
- **ci**: rag prebuild wrong the whole time
- try again???
- **docs**: show mobile navigation menu (#2364)
- **docs**: make site responsive across viewports (#2362)
