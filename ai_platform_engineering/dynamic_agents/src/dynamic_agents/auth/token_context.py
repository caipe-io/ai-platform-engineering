...
This is the DA-local mirror of the shared
...
factory can be wired together without taking a dependency on the shared
``ai_platform_engineering`` package (the DA ships as its own deploy unit).
