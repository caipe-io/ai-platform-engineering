...
async function createIndexes(db: Db) {
  ...
  await Promise.all([
    ...
    // RAG collections are saved search-time filters. Datasource content
    // remains in Milvus under datasource_id; this is control-plane
    // membership and delegation only.
