...
helm install skill-scanner oci://ghcr.io/caipe-io/charts/skill-scanner --version 1.1.0

# Upgrade an existing release
helm upgrade skill-scanner oci://ghcr.io/caipe-io/charts/skill-scanner --version 1.1.0
```
...
helm show values oci://ghcr.io/caipe-io/charts/skill-scanner --version 1.1.0
```
