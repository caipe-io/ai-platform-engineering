...
helm install autonomous-agents oci://ghcr.io/caipe-io/charts/autonomous-agents --version 1.1.0

# Upgrade an existing release
helm upgrade autonomous-agents oci://ghcr.io/caipe-io/charts/autonomous-agents --version 1.1.0
```
...
helm show values oci://ghcr.io/caipe-io/charts/autonomous-agents --version 1.1.0
```
