...
helm install keycloak oci://ghcr.io/caipe-io/charts/keycloak --version 1.1.0

# Upgrade an existing release
helm upgrade keycloak oci://ghcr.io/caipe-io/charts/keycloak --version 1.1.0
```
...
helm show values oci://ghcr.io/caipe-io/charts/keycloak --version 1.1.0
```
...
| jobPodSecurityContext.runAsGroup | int | `65532` |  |
| jobPodSecurityContext.runAsNonRoot | bool | `true` |  |
| jobPodSecurityContext.runAsUser | int | `65532` |  |
...
| jobSecurityContext.runAsGroup | int | `65532` |  |
| jobSecurityContext.runAsNonRoot | bool | `true` |  |
| jobSecurityContext.runAsUser | int | `65532` |  |
