...
helm install mcp-server oci://ghcr.io/caipe-io/charts/mcp-server --version 1.1.0

# Upgrade an existing release
helm upgrade mcp-server oci://ghcr.io/caipe-io/charts/mcp-server --version 1.1.0
```
...
helm show values oci://ghcr.io/caipe-io/charts/mcp-server --version 1.1.0
```
