...
helm install rag-ingestors oci://ghcr.io/caipe-io/charts/rag-ingestors --version 1.0.0

# Upgrade an existing release
helm upgrade rag-ingestors oci://ghcr.io/caipe-io/charts/rag-ingestors --version 1.0.0
```
...
helm show values oci://ghcr.io/caipe-io/charts/rag-ingestors --version 1.0.0
```
