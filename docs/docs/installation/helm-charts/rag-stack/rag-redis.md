...
helm install rag-redis oci://ghcr.io/caipe-io/charts/rag-redis --version 1.0.0

# Upgrade an existing release
helm upgrade rag-redis oci://ghcr.io/caipe-io/charts/rag-redis --version 1.0.0
```
...
helm show values oci://ghcr.io/caipe-io/charts/rag-redis --version 1.0.0
```
